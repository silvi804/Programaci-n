...
print(Color.Green)
print("""
    Este programa está hecho para decirle que día de la semana es acorde a la fecha que ingresó.
...
semana= {1:"Lunes",2:"Martes",3:"Miercoles",4:"Jueves",5:"Viernes",6:"Sábado",0:"Domingo"} #D
siglos={}
